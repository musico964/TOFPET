// megafunction wizard: %altmemphy v13.0%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			EthernetSystem_sdram_phy_alt_mem_phy
// ============================================================
// Generated by altmemphy 13.0 [Altera, IP Toolbench 1.3.0 Build 232]
// ************************************************************
...
module EthernetSystem_sdram_phy (
	pll_ref_clk,
	global_reset_n,
	soft_reset_n,
	ctl_dqs_burst,
	...
	EthernetSystem_sdram_phy_alt_mem_phy	EthernetSystem_sdram_phy_alt_mem_phy_inst(
	...
	defparam
		EthernetSystem_sdram_phy_alt_mem_phy_inst.FAMILY = "Arria II GX",
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR3",
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "HIGH",
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 10,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DQS_PHASE = 7200,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 3333,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "3333 ps",
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 4625,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 70,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 32,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 1,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		EthernetSystem_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0,
		EthernetSystem_sdram_phy_alt_mem_phy_inst.INVERT_POSTAMBLE_CLK = "false";
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="13.0"  build="198"  iptb_version="1.3.0 Build 232"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="EthernetSystem_sdram_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Micron ArriaIIGX_DDR3_Kit(MT41J64M16LA-15E)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_fmax" value="667.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tiha_ps" value="140"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_tdsh_ck" value="0.2"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_if_trfc_ns" value="49.5"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_tqh_ck" value="0.38"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_tisa_ps" value="190"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tdsa_ps" value="65"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_tac_ps" value="400"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_tdha_ps" value="30"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tcl_50_fmax" value="80.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "ref_clk_source" value="clkin_100"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "qsys_mode" value="true"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tcl_90_fmax" value="533.333"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_rtt_wr" value="Dynamic ODT off"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_tcl_100_fmax" value="80.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "t_DS_calculated" value="0,197"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "t_DH" value="0.166"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "t_DH_calculated" value="0,166"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "t_DS" value="0.197"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "use_alt_top" value="1"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "alt_top" value="EthernetSystem_sdram_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="EthernetSystem_sdram_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+EthernetSystem_sdram_phy_alt_mem_phy_seq_wrapper;+EthernetSystem_sdram_phy_alt_mem_phy_reconfig;+EthernetSystem_sdram_phy_alt_mem_phy_pll;+EthernetSystem_sdram_phy_alt_mem_phy_delay;+EthernetSystem_sdram_phy_alt_mem_phy_dq_dqs --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\musico\AppData\Local\Temp\alt6126_5677327034672556054.dir\0014_iptb_gen/EthernetSystem_sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="EthernetSystem_sdram_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
