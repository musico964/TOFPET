...
`timescale 1 ps / 1 ps
module EthernetSystem_ext_flash #(
		parameter TCM_ADDRESS_W                  = 26,
		parameter TCM_DATA_W                     = 16,
		parameter TCM_BYTEENABLE_W               = 2,
		parameter TCM_READ_WAIT                  = 110,
		parameter TCM_WRITE_WAIT                 = 110,
	...
	altera_merlin_slave_translator #(
		...
		.AV_READ_WAIT_CYCLES            (11),
		.AV_WRITE_WAIT_CYCLES           (11),
