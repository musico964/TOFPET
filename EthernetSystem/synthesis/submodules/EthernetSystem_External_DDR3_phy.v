...
// ============================================================
// Megafunction Name(s):
// 			EthernetSystem_External_DDR3_phy_alt_mem_phy
// ============================================================
...
module EthernetSystem_External_DDR3_phy (
	pll_ref_clk,
	global_reset_n,
	soft_reset_n,
	ctl_dqs_burst,
	...
	EthernetSystem_External_DDR3_phy_alt_mem_phy	EthernetSystem_External_DDR3_phy_alt_mem_phy_inst(
	...
	defparam
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.FAMILY = "Arria II GX",
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR3",
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "HIGH",
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 8,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DQS_PHASE = 9000,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 2500,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "2500 ps",
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 5201,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 2,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 16,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 24,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 1,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0,
		EthernetSystem_External_DDR3_phy_alt_mem_phy_inst.INVERT_POSTAMBLE_CLK = "false";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="EthernetSystem_External_DDR3_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="EthernetSystem_External_DDR3_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="EthernetSystem_External_DDR3_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+EthernetSystem_External_DDR3_phy_alt_mem_phy_seq_wrapper;+EthernetSystem_External_DDR3_phy_alt_mem_phy_reconfig;+EthernetSystem_External_DDR3_phy_alt_mem_phy_pll;+EthernetSystem_External_DDR3_phy_alt_mem_phy_delay;+EthernetSystem_External_DDR3_phy_alt_mem_phy_dq_dqs --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\musico\AppData\Local\Temp\alt6121_5263854368174917407.dir\0002_iptb_gen/EthernetSystem_External_DDR3_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="EthernetSystem_External_DDR3_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
