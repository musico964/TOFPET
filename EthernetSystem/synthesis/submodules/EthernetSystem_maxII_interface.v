// EthernetSystem_maxII_interface.v
...
`timescale 1 ps / 1 ps
module EthernetSystem_maxII_interface #(
		parameter TCM_ADDRESS_W                  = 5,
		...
		input  wire [4:0]  uas_address,          //   uas.address
		...
		output wire [4:0]  tcm_address_out,      //      .address_out
	...
	wire   [4:0] tdt_avalon_universal_master_0_address;           // tdt:m0_uav_address -> slave_translator:uav_address
	...
	wire   [4:0] slave_translator_avalon_anti_slave_0_address;    // slave_translator:av_address -> tda:av_address
