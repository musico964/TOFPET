...
SOPCINFO_FILE := C:/Users/musico/Documents/INFN/TOPEM/EndoProbe/AlteraDevelBoards/DK-DEV-A2GX125N_Eth/EthernetSystem.sopcinfo
...
# Design Name 
# setting SOPC_NAME is EthernetSystem
SOPC_NAME := EthernetSystem
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80000b0
SOPC_SYSID_FLAG += --sidp=0x80000b0
ELF_PATCH_FLAG  += --sidp 0x80000b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1393927477
SOPC_SYSID_FLAG += --timestamp=1393927477
ELF_PATCH_FLAG  += --timestamp 1393927477
