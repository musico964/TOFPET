...
MEM_0 := EthernetSystem_descriptor_memory
...
$(MEM_0)_START := 0x09100000
$(MEM_0)_END := 0x09101fff
...
# Memory: onchip_SRAM
MEM_2 := EthernetSystem_onchip_SRAM
$(MEM_2)_NAME := onchip_SRAM
...
$(MEM_2)_START := 0x09080000
$(MEM_2)_END := 0x090fffff
$(MEM_2)_HIERARCHICAL_PATH := onchip_SRAM
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: onchip_SRAM
onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
